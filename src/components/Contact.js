            ...
            <div className="row g-4">
                <div className="col-lg-4">
                    <div className="h-100 bg-light rounded d-flex align-items-center p-5">
                        ...
                        <div className="ms-4">
                            ...
                            <h5 className="mb-0">301201 Deepak Vihar khoda colony (GZB)</h5>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
                ...
                <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <div className="bg-light rounded p-5">
                        ...
                        <p className="mb-4">The contact form is currently inactive. Get a functional and working contact form with experties in a few minutes. Just copy and paste the files, add a little code and you're done.</p>
                        <form>
